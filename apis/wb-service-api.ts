...
export const WbServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async cleanSlide(sid: string, roomid: number, wbid: number, slide: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceResultWrapper>> {
         ...
         * @throws {RequiredError}
         */
        async cleanWb1(sid: string, roomid: number, wbid: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceResultWrapper>> {
         ...
         * @throws {RequiredError}
         */
        async resetWb(sid: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceResultWrapper>> {
         ...
         * @throws {RequiredError}
         */
        async uploadWb(sid: string, type: string, data?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceResultWrapper>> {
...
export const WbServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        cleanSlide(sid: string, roomid: number, wbid: number, slide: number, options?: any): AxiosPromise<ServiceResultWrapper> {
         ...
         * @throws {RequiredError}
         */
        cleanWb1(sid: string, roomid: number, wbid: number, options?: any): AxiosPromise<ServiceResultWrapper> {
         ...
         * @throws {RequiredError}
         */
        resetWb(sid: string, id: number, options?: any): AxiosPromise<ServiceResultWrapper> {
         ...
         * @throws {RequiredError}
         */
        uploadWb(sid: string, type: string, data?: string, options?: any): AxiosPromise<ServiceResultWrapper> {
