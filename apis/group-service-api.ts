...
import { GroupDTOListWrapper } from '../models';
import { ServiceResultWrapper } from '../models';
import { UserSearchResultWrapper } from '../models';
/**
...
export const GroupServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async add1(sid: string, name: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceResultWrapper>> {
         ...
         * @throws {RequiredError}
         */
        async addRoom(sid: string, id: number, roomid: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceResultWrapper>> {
         ...
         * @throws {RequiredError}
         */
        async addUser(sid: string, id: number, userid: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceResultWrapper>> {
         ...
         * @throws {RequiredError}
         */
        async delete2(sid: string, id: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceResultWrapper>> {
         ...
         * @throws {RequiredError}
         */
        async get1(sid: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GroupDTOListWrapper>> {
         ...
         * @throws {RequiredError}
         */
        async getUsers(sid: string, id: number, start: number, max: number, orderby: string, asc: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserSearchResultWrapper>> {
         ...
         * @throws {RequiredError}
         */
        async removeUser(sid: string, id: number, userid: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceResultWrapper>> {
...
export const GroupServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        add1(sid: string, name: string, options?: any): AxiosPromise<ServiceResultWrapper> {
         ...
         * @throws {RequiredError}
         */
        addRoom(sid: string, id: number, roomid: number, options?: any): AxiosPromise<ServiceResultWrapper> {
         ...
         * @throws {RequiredError}
         */
        addUser(sid: string, id: number, userid: number, options?: any): AxiosPromise<ServiceResultWrapper> {
         ...
         * @throws {RequiredError}
         */
        delete2(sid: string, id: number, options?: any): AxiosPromise<ServiceResultWrapper> {
         ...
         * @throws {RequiredError}
         */
        get1(sid: string, options?: any): AxiosPromise<GroupDTOListWrapper> {
         ...
         * @throws {RequiredError}
         */
        getUsers(sid: string, id: number, start: number, max: number, orderby: string, asc: boolean, options?: any): AxiosPromise<UserSearchResultWrapper> {
         ...
         * @throws {RequiredError}
         */
        removeUser(sid: string, id: number, userid: number, options?: any): AxiosPromise<ServiceResultWrapper> {
